...
fun main(args: Array<String>) {
    ...
    val x: String? = "I AM IN UPPERCASE" //? assume que pode ser null
    ...
    x?.let { println(it.toLowerCase().replace("am", "am not"))} //se x=null, nem executa essa linha
    ...
    val myNonNullVariable: Int? = null  //so deixa atribuir valor null com ?
     //myNonNullVariable!!.toDouble() //nullPointer... Sem !! nem compila. Com '?' nao lanca exececao
